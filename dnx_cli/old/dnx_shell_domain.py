...
class Domain:
    def __init__(self, Main):
        ...
        with open(f'{HOME_DIR}/dnx_profile/data/dns_proxy.cfg', 'r') as categories:
    ...
    def ShowStatus(self, arg):
        with open(f'{HOME_DIR}/dnx_profile/data/dns_proxy.cfg', 'r') as settings:
    ...
    def ChangeStatus(self, comm, arg, option):
        ...
        if (old_status == new_status):
            ...
            with open(f'{HOME_DIR}/dnx_profile/data/dns_proxy.cfg', 'w') as settings:
