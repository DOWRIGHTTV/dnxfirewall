...
class text:
    ...
    @staticmethod
    def black(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def red(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def green(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def orange(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def blue(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def purple(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def cyan(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def lightgrey(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def darkgrey(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def lightred(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def lightgreen(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def yellow(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def lightblue(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def pink(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
    ...
    @staticmethod
    def lightcyan(t: str, style: Optional[_Styles] = styles.bold) -> str:
        if not t.strip():
            return ''
