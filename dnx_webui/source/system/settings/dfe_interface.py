...
class WebPage(StandardWebPage):
    ...
    def load(_: Form) -> dict[str, Any]:
        ...
        zone_list = [(z_id, z_info[0]) for z_id, z_info in system_settings.get_items('zones->builtin')]
        zone_list.extend([(z_id, z_info[0]) for z_id, z_info in system_settings.get_items('zones->extended')])
