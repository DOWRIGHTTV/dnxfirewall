...
_GEO_LIST = [
    ...
    'PUERTO_RICO', 'QATAR', 'REUNION', 'RFC1918', 'ROMANIA', 'RUSSIAN_FEDERATION', 'RWANDA', 'SAINT_HELENA',
    'SAINT_LUCIA', 'SAINT_MARTIN', 'SAINT_PIERRE_AND_MIQUELON', 'SAMOA', 'SAN_MARINO', 'SAUDI_ARABIA', 'SENEGAL',
    ...
    'TOKELAU', 'TONGA', 'TRINIDAD_AND_TOBAGO', 'TUNISIA', 'TURKEY', 'TURKMENISTAN', 'TURKS_AND_CAICOS_ISLANDS',
    'TUVALU', 'UGANDA', 'UKRAINE', 'UNITED_ARAB_EMIRATES', 'UNITED_KINGDOM', 'UNITED_STATES', 'URUGUAY',
    'US_MINOR_OUTLYING_ISLANDS', 'UZBEKISTAN', 'VANUATU', 'VENEZUELA', 'VIETNAM', 'WESTERN_SAHARA', 'YEMEN', 'ZAMBIA',
    'ZIMBABWE'
]
